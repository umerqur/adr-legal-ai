...
@media(max-width:768px){
  *{box-sizing:border-box}
  ...
  .contact-info{flex-direction:column;text-align:center;padding:0 1rem;gap:0.5rem}
...
<body>
    ...
    <div class="header">
        ...
        <div class="status-badge">Legal Disclaimer: This AI provides informational analysis only and does not constitute legal advice. Consult ADR Chambers for professional guidance.</div>
    </div>
